...
当前共 **35 张正式素材**，原图归档，界面使用独立 WebP 派生图：
...
网页派生图共 52 张：11 张场景（10 张1440×960、账房1440×811）、7 张设备（420×420）、17 张商品详情（420×420）及 17 张商品缩略图（96×96）。文件路径、实际尺寸、字节数和校验值见 [网页素材清单](../../public/art/manifest.json)。

- 细节更新：[账房插画与生成提示词](scenes/ledger-generation.md)，新增1张场景原图（1672×941）。
- 商品修订：[炊饼替换记录](goods/bread-replacement.md)，当前原图以切开的面食断面区分鸡蛋。
